...
export const FIL = {
  ...
  label_button_try_app: 'Subukan ang app ng walang account',
  ...
  label_button_tc_agree: 'Sumasang-ayon ako sa mga tuntunin at kundisyon',
  ...
  label_text_congrats_text: 'Ngayon i-save ang lugar sa pamamagitan ng pagberika sa datos.',
  ...
  label_no_connection_note: 'Ipagpatuloy ang ginagawang pagmamapa tulad ng dati. Ang trashpoint ay kusang maipapadala sa server sa oras na ikaw ay magkaroon ng internet.',
  label_your_coordinates: 'Iyong koordination',
  label_header_team_profile: 'Profile ng grupo',
  label_button_join_team: 'Sumali sa grupo',
  label_button_leave_team: 'Umalis sa grupo',
  label_text_global_team: 'Pang daigdigan',
  label_text_members: 'mga miyembro',
  label_text_team_trash_points: 'Trashpoints ng miyembro',
  label_text_latest_activity: 'Pinakabagong aktibidad',
  label_text_select_leave: 'Kailangan mo ba talagang lumisan sa grupo',
  label_text_select_join: 'Gusto mo ba talaga sumali sa koponan',
  label_button_join: 'Sali',
  label_button_leave: 'Umalis',
  label_text_my_team: 'Ang aking koponan',
  label_text_team: 'Koponan',
  label_teams_header: 'Mga koponan',
  label_text_your_team: 'Ang iyong koponan: ',
  label_text_join_a_team: 'Sumali sa grupo',
  label_text_join_a_team_description: 'Sumali sa iyong mga kapatid sa braso!',
  label_text_search_placeholder: 'Mag hanap ng koponan',
  label_text_search_teams: 'Mag hanap ng mga koponan',
  label_text_search_for_a_team: 'Mag hanap ng koponan!',
  label_text_work_together: 'Mag trabaho kasama ang ibang tao at gumawa ng grupong nakikipagkumpitensya. ang panalo ay ang mundo!',
  label_text_trashpoint: 'Punto ng basura',
  label_no: 'Hindi',
  label_yes: 'Oo',
  ...
  label_trash_status_urgent: 'banta',
  label_TP_updates: 'UPDATES',
  label_trashpoint: 'Punto ng basura',
